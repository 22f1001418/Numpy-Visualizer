...
import { Sun, Moon, PanelLeftClose, PanelLeft, Keyboard } from "lucide-react";
    ...
    <>
      ...
      >
        <div className="min-w-[270px] flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-4 pt-5 pb-3">
            <button className="flex items-center gap-2.5" onClick={() => setPage("home")}>
              ...
              <div>
                ...
                <div className="text-[9px] text-txt-muted font-mono mt-0.5">Interactive · Animated · v3</div>
              </div>
            </button>
          ...
          {/* Footer */}
          <div className="px-4 py-3 border-t border-edge space-y-1">
            <div className="flex items-center gap-1.5 text-[9px] text-txt-muted font-mono">
              <Keyboard size={10} /> <span>Space = play · ← → = step</span>
            </div>
